...
class EspdController {
    ...
    private void setDefaultDatesForTurnoverFields(EspdDocument document) {
        document.getGeneralYearlyTurnover().setUnboundedGroups(buildTurnoverRequirementGroups());
        document.getSpecificYearlyTurnover().setUnboundedGroups(buildTurnoverRequirementGroups());
    }

    private List<DynamicRequirementGroup> buildTurnoverRequirementGroups() {
        int numberOfYears = 5;
        List<DynamicRequirementGroup> groups = new ArrayList<>(numberOfYears);
        for (int year = 1; year <= numberOfYears; year++) {
            groups.add(buildTurnoverDynamicRequirementGroupForYear(year));
        }
        return groups;
    }

    private DynamicRequirementGroup buildTurnoverDynamicRequirementGroupForYear(int year) {
        DynamicRequirementGroup drg = new DynamicRequirementGroup();

        Date startOfYear = new DateTime()
                .minusYears(year)
                .dayOfYear()
                .withMinimumValue()
                .withTimeAtStartOfDay()
                .toDate();
        Date endOfYear = new DateTime()
                .minusYears(year)
                .dayOfYear()
                .withMaximumValue()
        ...
        drg.put("startDate", startOfYear);
        drg.put("endDate", endOfYear);
    ...
    public String addCriminalConvictions(@PathVariable String flow,
            @RequestParam("add_criminalConvictions") Integer addIndex, @ModelAttribute("espd") EspdDocument espd,
            BindingResult bindingResult) {
    ...
    public String addCorruption(@PathVariable String flow,
            @RequestParam("add_corruption") Integer addIndex, @ModelAttribute("espd") EspdDocument espd,
            BindingResult bindingResult) {
    ...
    public String addFraud(@PathVariable String flow,
            @RequestParam("add_fraud") Integer addIndex, @ModelAttribute("espd") EspdDocument espd,
            BindingResult bindingResult) {
    ...
    public String addTerroristOffences(@PathVariable String flow,
            @RequestParam("add_terroristOffences") Integer addIndex, @ModelAttribute("espd") EspdDocument espd,
            BindingResult bindingResult) {
    ...
    public String addMoneyLaundering(@PathVariable String flow,
            @RequestParam("add_moneyLaundering") Integer addIndex, @ModelAttribute("espd") EspdDocument espd,
            BindingResult bindingResult) {
    ...
    public String addchildLabour(@PathVariable String flow,
            @RequestParam("add_childLabour") Integer addIndex, @ModelAttribute("espd") EspdDocument espd,
            BindingResult bindingResult) {
    ...
    public String removeCriminalConvictions(@PathVariable String flow,
            @RequestParam("remove_criminalConvictions") Integer removeIndex, @ModelAttribute("espd") EspdDocument espd,
            BindingResult bindingResult) {
        return removeMultipleReference(espd.getCriminalConvictions(), removeIndex, "#criminalConvictions", flow,
                "exclusion");
    }

    @PostMapping(value = "/{flow:request|response}/eo/exclusion", params = "remove_corruption")
    public String removeCorruption(@PathVariable String flow, @RequestParam("remove_corruption") Integer removeIndex,
            @ModelAttribute("espd") EspdDocument espd, BindingResult bindingResult) {
    ...
    public String removeFraud(@PathVariable String flow, @RequestParam("remove_fraud") Integer removeIndex,
            @ModelAttribute("espd") EspdDocument espd, BindingResult bindingResult) {
    ...
    public String removeTerroristOffences(@PathVariable String flow,
            @RequestParam("remove_terroristOffences") Integer removeIndex, @ModelAttribute("espd") EspdDocument espd,
            BindingResult bindingResult) {
        return removeMultipleReference(espd.getTerroristOffences(), removeIndex, "#terroristOffences", flow,
                "exclusion");
    }

    @PostMapping(value = "/{flow:request|response}/eo/exclusion", params = "remove_moneyLaundering")
    public String removeMoneyLaundering(@PathVariable String flow,
            @RequestParam("remove_moneyLaundering") Integer removeIndex, @ModelAttribute("espd") EspdDocument espd,
            BindingResult bindingResult) {
    ...
    public String removeChildLabour(@PathVariable String flow, @RequestParam("remove_childLabour") Integer removeIndex,
            @ModelAttribute("espd") EspdDocument espd, BindingResult bindingResult) {
